...
public class StringUtil {
	...
	public static boolean hasText(String src) {
		...
		if(src.length()==0) {
			...
			boolean flag = Pattern.matches(reg, src);
			if(flag==true) {
				return false;
			}else {
				return true;
	...
	public static String randomChineseString(int length) {
		...
		for(int i=0;i<length;i++) {
			...
			String onerandomchinese = (char)(random.nextInt(40869-19968+1)+19968)+"";
			result+=onerandomchinese;
		}
		return result;
	}
	/**
	...
	public static String generateChineseName() {
		String [] src= {"赵","钱","孙","李","周","吴","郑","王","冯","陈","楮","卫","蒋","沈","韩","杨","朱","秦",
						...
						"查","后","荆","红","游","竺","权","逑","盖","益","桓","公","晋","楚","阎","法","汝","鄢",
						"涂","钦","岳","帅","缑","亢","况","后","有","琴","商","牟","佘","佴","伯","赏","墨","哈",
						"谯","笪","年","爱","阳","佟","万俟","司马","上官","欧阳","夏侯","诸葛","闻人","东方","赫连",
						"皇甫","尉迟","公羊","澹台","公冶","宗政","濮阳","淳于","单于","太叔","申屠","公孙","仲孙",
						"轩辕","令狐","锺离","宇文","长孙","慕容","鲜于","闾丘","司徒","司空","丌官","司寇","仉","督",
						"子车","颛孙","端木","巫马","公西","漆雕","乐正","壤驷","公良","拓拔","夹谷","宰父","谷梁",
						"段干","百里","东郭","南门","呼延","归","海","羊舌","微生","梁丘","左丘","东门","西门","南宫"};
		String result="";
		Random random=new Random();
		int index = RandomUtil.getOneRandom(0, src.length-1);
		if(random.nextBoolean()) {
			result+=src[index]+randomChineseString(1);
		}else {
			result+=src[index]+randomChineseString(2);
		}
		return result;
	}
}
